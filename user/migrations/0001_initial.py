    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branches', models.ManyToManyField(related_name='salesmen_set', to='user.branchgroup')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('representing', models.ForeignKey(db_column='company_name', null=True, on_delete=django.db.models.deletion.CASCADE, to='user.company')),
