    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_group', models.OneToOneField(db_column='branch_name', on_delete=django.db.models.deletion.CASCADE, to='Salesman.branchgroup')),
                ('departments', models.ManyToManyField(to='Supervisor.departmentboard')),
            ],
        ),
    ]
